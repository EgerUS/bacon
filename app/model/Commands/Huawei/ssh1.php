 ...
 * Encoding:    UTF-8 
 * 
 * Description: Huawei SSH1 library
 * 
 * 
 */ 
...
class SSH1 extends \Nette\Object {
	...
	{
		@$this->lastCommandResult = $this->connection->read($this->prompt, NET_SSH1_READ_REGEX);
	}
	...
	{ 
		@$this->connection = new \Net_SSH1($this->script->deviceHost, $this->port, $this->timeout, NET_SSH1_CIPHER_DES);
